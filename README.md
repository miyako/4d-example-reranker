...
> This model is a repurposed decoder. It performs better on GGUF "K" quants. Also the pooling on ONNX might be incorrect [#1](https://github.com/miyako/4d-example-reranker/issues/1).
